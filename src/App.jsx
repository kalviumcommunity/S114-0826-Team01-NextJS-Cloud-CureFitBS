...
const API_BASE = process.env.REACT_APP_API_BASE || 'https://onrender.com';
const WS_URL = process.env.REACT_APP_WS_URL || 'wss://s114-0826-team01-nextjs-cloud-curefitbs-jrmt.onrender.com';
...
export default function App() {
  ...
  const [userEmail, setUserEmail] = useState(localStorage.getItem('curefit_email'));
